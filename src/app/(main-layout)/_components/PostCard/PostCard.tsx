...
const PostCard = ({ recipe }: any) => {
  return (
    <div className="min-h-[400px] lg:min-w-full mx-auto w-[90%] sm:w-[90%] md:w-[600px] border border-default-300 p-5 rounded-md  shadow-xl shadow-primary-100 overflow-hidden transition ease-in-out duration-300 transform hover:shadow-2xl ">
